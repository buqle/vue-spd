  ...
  <div class="condition">
    <div class="condition-row">
     ...
     <div class="condition-row mb15">
      <Button type="default" size="large" class="l" @click="add()">新建补货计划</Button>
    ...
    <Modal v-model="modal" fullscreen title="新建补货计划" :loading="loading1">
      <div class="condition">
        <div class="condition-row mb15">
         ...
         <Table :columns="columns2" :data="backGoodsLists" style="width: 100%"  @on-selection-change="handleGoodsChange"></Table>
                 </div>
                 <div slot="footer">
    ...
    <Modal v-model="modalGoods" title="添加产品" width="1200" @on-cancel="modalReset"  @on-ok="asyncOK">
      <div class="condition">
        <div class="condition-row">
          ...
          <div class="condition-group">
             <Checkbox v-model="page1.filterThreeMonthFlag" class="big condition-group-ipt" style="margin-top: 5px;">不显示三个月无采购的药品</Checkbox>
          </div>
        </div> 
         <div class="condition-row mb15">
          <Button size="large" type="default" icon="ios-search" class="r" @click="queryDrugByDeptListClick(true)">查询</Button>
         </div>
       </div>
                                  ...
                                  h('div', {
                                      ...
                                      on: {
                                          click: () => {
                                              ...
                                              this.$router.push({path: "/purchase/replenishment/replenishmentPlan/details", query:{id:params.row.planCode}})
                                          }
                                      }
                                  },params.row.planCode), 
                                  h('p', {
