...
export default {
	                                ...
	                                h('div', {
	                                    ...
	                                    on: {
	                                        click: () => {
	                                            ...
	                                            this.$router.push({path: "/drugStorage/checkDecrease/afterAdjustment/details", query:{id:params.row.checkBillNo}})
	                                        }
	                                    }
	...
	methods:{
		...
		async stateListClick(){
			let datalist = await this.$api.publics.typeList({'type':'check_status','values':'4,5'});
