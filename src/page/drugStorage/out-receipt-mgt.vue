	...
	<div class="condition">
		<div class="condition-row">
			<div class="condition-group">
				<label>申领部门</label>
				<Select v-model="page.hisDrugCode" clearable class="condition-group-ipt">
		...
		<div class="condition-row">
			...
			<div class="condition-group">
				<label>单据号</label>
				<Input placeholder="申领单/拣货单" v-model="page.orderNo" class="condition-group-ipt"></Input>
			</div>
		</div>
	             <div class="condition-row">
	                                ...
	                                h('div', {
	                                    ...
	                                    on: {
	                                        click: () => {
	                                            ...
	                                            this.$router.push({path: "/drugStorage/outStorage/outReceiptMgt/details", query:{id:params.row.backNo,state:params.row.outStoreStatus}})
	                                        }
	                                    }
	                                },params.row.backNo), 
	                                h('p', {
