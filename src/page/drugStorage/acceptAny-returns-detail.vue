<template>
	...
	<Card dis-hover :bordered="false">
	            ...
	            <p slot="extra" class="btn-style">
	                ...
	                <Button type="primary" @click="confirm()">确认拣货</Button> <!-- v-if="this.comlist.status == '1' || this.comlist.status == '9'" -->
	                <Button type="primary" @click="to()">下一步复核</Button>
					...
					align: 'center',
					 render: (h, params) => {
					 		return h('InputNumber', {
						                    props: {
						                    	min:1,
						                    	max:params.index.allocationNum,
						                          type: 'text',
