<template>
	...
	<Card dis-hover :bordered="false">
		...
		<div class="r mt15">
	             	<Page :total="page.totalPage" :page-size="page.pageSize" :current.sync="page.pageNo" @on-change="getMedCommonOutStoreDetailListClick()" show-total show-elevator />
	             </div>
	</div>  
</template>
<script> 
...
export default {
	...
	methods: {
		// 列表
		async getMedCommonOutStoreDetailListClick(){
			this.druhList = [];
			this.spinShow = true;
  ...
  //       			let datalist = await this.$api.druhStorage.exportAsPrintList(item);
	...
	created(){
		...
		// 列表
		this.getMedCommonOutStoreDetailListClick();
	},
	watch: { 
